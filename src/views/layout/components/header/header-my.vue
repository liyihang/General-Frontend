<template>
  <m-popover class="flex items-center" placement="bottom-left">
    <template #reference>
      <div
           class="relative flex items-center px-0.5 rounded-sm cursor-pointer duration-200 outline-none hover:bg-zinc-100">
        <!-- 头像 -->
        <img class="w-3 h-3 rounded-sm"
             src="https://himg.bdimg.com/sys/portrait/item/wise.1.120c85cf.v7-qnE5vKdlp63X3ya5uuA.jpg" />
        <!-- 下箭头 -->
        <m-svg-icon name="down-arrow" class="w-1.5 h-1.5 ml-0.5" fillClass="fill-zinc-900"></m-svg-icon>
